  ...
  return (
    <div className='h-full overflow-y-auto p-4 flex items-start flex-wrap gap-4 text-slate-700'>
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <input onChange={(e)=>setInput(e.target.files[0])} type="file" accept='image/*' name="" id="" className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300 text-gray-600' required/>
          <p className='text-xs txt-gray-500 font-light mt-1'>Supports JPG, PNG, and other image formats</p>
